...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 29 2023 г., 19:12
...
(6, '2023_01_11_162050_create_categories_table', 1),
(7, '2023_01_11_162051_create_posts_table', 1),
(8, '2023_01_11_162216_create_tags_table', 1),
(9, '2023_01_11_162255_create_post_tags_table', 1),
(10, '2023_01_11_162340_create_comments_table', 1),
(11, '2023_01_11_162437_create_post_user_likes_table', 1);
...
(1, 'admin', 'admin@gmail.com', NULL, '$2y$10$7lQqgNDkWlynJq0J3inJl.nERhPnsry9C6/Bv.KvXEof5WVDrFz6i', 1, NULL, '2023-01-29 18:07:19', '2023-01-29 18:07:19', NULL);
...
ALTER TABLE `comments`
  ...
  ADD KEY `comment_comment_idx` (`comment_id`);
...
ALTER TABLE `post_user_likes`
  ADD KEY `post_user_like_post_idx` (`post_id`),
  ADD KEY `post_user_like_user_idx` (`user_id`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comment_comment_fk` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`),
...
--
ALTER TABLE `post_user_likes`
  ADD CONSTRAINT `post_user_like_post_fk` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `post_user_like_user_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
