                            ...
                            <form class="form-horizontal" action="{{ route('admin.post.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="title" id="title" class="form-control" value="{{ old('title') }}" placeholder="Введите название" autofocus>
                                            @error('title')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control select2" id="category" name="category_id" style="width: 100%;">
